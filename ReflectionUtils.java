...
public class ReflectionUtils {
     ...
     */
    public static <T> Class<T> getGenericParameterClass(final Class<?> actualClass, final Class<?> genericClass,
        ...
        while (true) {
            ...
            if (isParameterizedType) {
                ...
                // В иерархии встретился непараметризованный класс. Все ранее сохраненные параметризованные классы
                // будут бесполезны.
        ...
        if (result instanceof TypeVariable) {
            ...
            throw new IllegalStateException("Unable to resolve type variable " + result + "."
                                                + " Try to replace instances of parametrized class with its " +
    ...
    public static Object getFieldValue(@NonNull Object object, @NonNull String fieldName) {
        try {
            ...
            throw new IllegalArgumentException("Class " + object.getClass() + " does not contain field named \""
                                                   + fieldName + "\"");
        } catch (IllegalAccessException ignored) {
            //field is set accessible earlier
            return null;
        }
    }

    public static Object getEntityId(@NonNull Object entity) {
        Class<?> clazz = entity.getClass();

        if (!clazz.isAnnotationPresent(Entity.class)) {
            throw new IllegalArgumentException(clazz + " is not an entity class");
        }
        ...
        throw new IllegalArgumentException(clazz + " does not contain @Id field");
    }
}
